...
def main():
    ...
    for host in CREDS:
        ...
        for x in os.listdir("/home/student/Cohort/140/filestocopy/"): # iterate on directory contents
          if not os.path.isdir("/home/student/Cohort/140/filestocopy/"+x): # filter everything that is NOT a directory
            sftp.put("/home/student/Cohort/140/filestocopy/"+x, "/tmp/"+x) # move file to target location
